...
namespace MernisServiceAdapterReference
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="MernisServiceAdapterReference.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<MernisServiceAdapterReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(MernisServiceAdapterReference.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public MernisServiceAdapterReference.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(MernisServiceAdapterReference.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public MernisServiceAdapterReference.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(MernisServiceAdapterReference.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface KPSPublicSoapChannel : MernisServiceAdapterReference.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceAdapterReference.KPSPublicSoap>, MernisServiceAdapterReference.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MernisServiceAdapterReference.TCKimlikNoDogrulaResponse> MernisServiceAdapterReference.KPSPublicSoap.TCKimlikNoDogrulaAsync(MernisServiceAdapterReference.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<MernisServiceAdapterReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            MernisServiceAdapterReference.TCKimlikNoDogrulaRequest inValue = new MernisServiceAdapterReference.TCKimlikNoDogrulaRequest();
            inValue.Body = new MernisServiceAdapterReference.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((MernisServiceAdapterReference.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
